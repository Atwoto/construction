...
const clientSchema = yup.object().shape({
  ...
  companySize: yup.string().oneOf(COMPANY_SIZES.map(s => s.value)).optional().nullable(),
  status: yup.string().oneOf(CLIENT_STATUSES.map(s => s.value)).optional(),
  source: yup.string().oneOf(CLIENT_SOURCES.map(s => s.value)).optional(),
  assignedTo: yup.string().optional().nullable(),
  rating: yup.number().min(1).max(5).optional().nullable(),
  estimatedValue: yup.number().min(0, "Value cannot be negative").optional().nullable(),
  ...
  preferredContactMethod: yup.string().oneOf(CONTACT_METHODS.map(c => c.value)).optional(),
      ...
      <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              {errors.companyName && (
                <p className="text-red-500 text-xs mt-1">{errors.companyName.message?.toString()}</p>
              )}
            </div>
            <div>
              ...
              {errors.contactPerson && (
                <p className="text-red-500 text-xs mt-1">{errors.contactPerson.message?.toString()}</p>
              )}
            </div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {errors.address && (
              <p className="text-red-500 text-xs mt-1">{errors.address.message?.toString()}</p>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              ...
              {errors.city && (
                <p className="text-red-500 text-xs mt-1">{errors.city.message?.toString()}</p>
              )}
            </div>
            <div>
              ...
              {errors.state && (
                <p className="text-red-500 text-xs mt-1">{errors.state.message?.toString()}</p>
              )}
            </div>
            <div>
              ...
              {errors.zipCode && (
                <p className="text-red-500 text-xs mt-1">{errors.zipCode.message?.toString()}</p>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              {errors.country && (
                <p className="text-red-500 text-xs mt-1">{errors.country.message?.toString()}</p>
              )}
            </div>
            <div>
              ...
              {errors.website && (
                <p className="text-red-500 text-xs mt-1">{errors.website.message?.toString()}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              />
              {errors.source && (
                <p className="text-red-500 text-xs mt-1">{errors.source.message?.toString()}</p>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              ...
              {errors.industry && (
                <p className="text-red-500 text-xs mt-1">{errors.industry.message?.toString()}</p>
              )}
            </div>
            <div>
              ...
              />
              {errors.companySize && (
                <p className="text-red-500 text-xs mt-1">{errors.companySize.message?.toString()}</p>
              )}
            </div>
            <div>
              <Label htmlFor="rating">Rating (1-5)</Label>
              <Input id="rating" type="number" {...register("rating")} min={1} max={5} placeholder="3" />
              {errors.rating && (
                <p className="text-red-500 text-xs mt-1">{errors.rating.message?.toString()}</p>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            <Input id="estimatedValue" type="number" {...register("estimatedValue")} placeholder="0" />
            {errors.estimatedValue && (
              <p className="text-red-500 text-xs mt-1">{errors.estimatedValue.message?.toString()}</p>
            )}
          </div>
        </div>
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-medium text-gray-900 border-b pb-2">Follow-up Information</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              {errors.lastContactDate && (
                <p className="text-red-500 text-xs mt-1">{errors.lastContactDate.message?.toString()}</p>
              )}
            </div>
            <div>
              ...
              {errors.nextFollowUpDate && (
                <p className="text-red-500 text-xs mt-1">{errors.nextFollowUpDate.message?.toString()}</p>
              )}
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            ></textarea>
            {errors.notes && (
              <p className="text-red-500 text-xs mt-1">{errors.notes.message?.toString()}</p>
            )}
          </div>
        </div>
