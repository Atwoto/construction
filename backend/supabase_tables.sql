...
-- Suppliers table (needed before materials)
...
-- Clients table (needed before projects and invoices)
...
-- Projects table (needed before tasks, invoices, documents, communications, timesheets, expenses)
...
-- Employees table (needed before tasks and timesheets)
